...
Component.entryPoint = function(NS){
    ...
    NS.AppWidget = Y.Base.create('appWidget', Y.Widget, [
        ...
        _syncUIAppWidget: function(){
            ...
            NS.initManager(function(appInstance){
                instance._initAppWidget(null, appInstance);
            });
        },
    ...
    Manager.prototype = {
        ...
        _updatePage: function(d){
            if (!L.isValue(d) || !L.isValue(d['page'])){
                return null;
            }
